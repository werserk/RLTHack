...
final_df['procedure_qty_full'] = (final_df['procedure_qty_44fz'] + final_df['procedure_qty_223fz']).fillna(0)
final_df['win_qty_full'] = (final_df['win_qty_44fz'] + final_df['win_qty_223fz']).fillna(0)
final_df['winrate_full'] = (final_df['win_qty_full'] / final_df['procedure_qty_full'])
